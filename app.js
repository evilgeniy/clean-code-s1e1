...
var addButton=document.querySelector(".button__add");//add button
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task__input task__edit";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="task__button button__edit";

    deleteButton.className="task__button button__delete";
